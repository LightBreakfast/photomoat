...
const themes = {
  light: {
    ...
    muted: [220, 14, 96] as const,
    'muted-foreground': [220, 10, 40] as const,
    accent: [220, 14, 42] as const,
    'accent-foreground': [0, 0, 100] as const,
    primary: [220, 14, 42] as const,
    'primary-foreground': [0, 0, 100] as const,
    secondary: [220, 14, 96] as const,
    'secondary-foreground': [220, 14, 14] as const,
    input: [220, 12, 65] as const,
  ...
  dark: {
    ...
    muted: [220, 12, 12] as const,
    'muted-foreground': [220, 10, 62] as const,
    accent: [220, 14, 68] as const,
    'accent-foreground': [220, 14, 14] as const,
    primary: [220, 14, 68] as const,
    'primary-foreground': [220, 14, 14] as const,
    secondary: [220, 12, 12] as const,
    'secondary-foreground': [220, 12, 88] as const,
    input: [220, 10, 35] as const,
...
const normalTextPairs: [Token, Token, string][] = [
  ...
  ['muted-foreground', 'background', 'status bar text'],
  ['muted-foreground', 'surface', 'secondary text'],
  ['muted-foreground', 'muted', 'secondary text on muted surface'],
  ['foreground', 'muted', 'outline and ghost hover text'],
  ['foreground', 'input', 'dark outline hover text'],
